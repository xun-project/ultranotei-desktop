...
enum class MessageType : quint8 { INPUT,
    OUTPUT };

const int MESSAGES_MODEL_COLUMN_COUNT = MessagesModel::staticMetaObject.enumerator(MessagesModel::staticMetaObject.indexOfEnumerator("Columns")).keyCount();
...
const QString MessagesModel::HEADER_INVOICE_ID = "Invoice-ID";
const QString MessagesModel::HEADER_INVOICE_AMOUNT = "Invoice-Amount";
const QString MessagesModel::HEADER_PAYMENT_ID = "Payment-ID";
    ...
    : QAbstractItemModel()
{
    ...
    connect(&WalletAdapter::instance(), &WalletAdapter::walletTransactionCreatedSignal, this,
        static_cast<void (MessagesModel::*)(cn::TransactionId)>(&MessagesModel::appendTransaction), Qt::QueuedConnection);
