...
void MainWindow::initUi()
{
    ...
    m_connectionStateIconLabel->setPixmap(QPixmap("qrc:/icons/icons/disconnected.png").scaled(16, 16, Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
    ...
    if (connection.compare("remote") == 0) {
        ...
        m_remoteModeIconLabel->setPixmap(QPixmap("qrc:/icons/icons/remote_mode.png").scaledToHeight(16, Qt::SmoothTransformation));
    }
...
void MainWindow::encryptedFlagChanged(bool _encrypted)
{
    ...
    QString encryptionIconPath = _encrypted ? "qrc:/icons/icons/lock_closed.png" : "qrc:/icons/icons/lock_open.png";
...
void MainWindow::peerCountUpdated(int _peerCount)
{
    QString connectionIconPath = _peerCount > 0 ? "qrc:/icons/icons/connected.png" : "qrc:/icons/icons/disconnected.png";
...
{
    QPixmap syncIcon = QPixmap("qrc:/icons/icons/synced.png").scaled(16, 16, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
