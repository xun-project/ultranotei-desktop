                                ...
                                ListView {
                                    ...
                                    model: ListModel {
                                        Component.onCompleted: {
                                            ...
                                            append({"text": qsTr("Invoices"), "iconSource": "qrc:/icons/resources/icons/drawer_send_invoice_list_item_icon.svg", "page": _invoicesPageComponent, "pageObjectName": "invoices_page" })
