...
Miner::Miner(QObject* _parent, const QString& _host, quint16 _port, const QString& _login, const QString& _password) : QObject(_parent), m_nonce(0), m_hashCounter(0), m_hashCountPerSecond(0), m_hashRateTimerId(-1) {
